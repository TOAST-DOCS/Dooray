...
버튼을 선택하면 서비스를 활성화할 수 있도록 서비스 활성화를 위한 조직 설정 화면을 확인할 수 있습니다.  
...
서비스를 활성화할 수 있도록 서비스 활성화를 위한 조직 설정 화면을 확인할 수 있습니다.  
...
완료 시 아래 그림과 같이 Dooray! 서비스 준비 완료 안내와 함께 Dooray! 서비스 군들 옆에 초록색 체크 아이콘이 보이면 활성화 된 것을 의미합니다.
완료 후 Dooray! 서비스 영역을 선택하면 Dooray! 서비스로 이동합니다. 
...
### 멤버 관리 
신규로 멤버를 등록하거나, 외부 사용자와 협업하고자 할 경우, '조직 관리 > 부서/멤버 관리 > 상태 관리'에서 [초대 중]을 선택합니다. 
프로젝트를 선택하고 멤버를 초대할 수 있으며, 프로젝트를 지정하지 않고도 초대할 수 있습니다. 멤버를 초대하기 위해서는 초대하고자 하는 사용자의 이메일 주소가 필요합니다.   
...
### 멤버 탈퇴 처리  
- '조직 관리 > 부서/멤버 관리 > 상태 관리'에서 [멤버 탈퇴]를 선택하여 탈퇴 처리할 수 있음
