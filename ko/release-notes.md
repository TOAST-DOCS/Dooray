 ...
 * Business 상품 가입자 제공
    * 메일 송수신 로그 감사 기능 제공
    * 프로젝트 서비스 포함 상품 가입 조직의 개인 용량 추가 기능 제공
 * 프로젝트 서비스 포함 상품 가입 조직의 프로젝트별 최대 용량 추가 기능 제공
 * 우상단 톱니바퀴 클릭 메뉴에서 신규 멤버/손님 초대 할 수 있도록 개선
...
#### 승인
 * 멤버/손님 추가, 용량 추가 신청 등 특정 기능 이용 시 승인 기능 제공
