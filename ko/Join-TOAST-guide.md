...
| --- | --- | --- | --- |
| 프로젝트+메일<br>(무료체험) | \* 개인 프로젝트 (드라이브): 업로드 된 파일 (휴지통 용량 포함)<br>\* 개인 프로젝트 (위키): 페이지 내 첨부 파일, 본문/댓글 이미지<br>\* 메일:  메일함 내 모든 메일 (대용량 첨부 파일 제외)<br>\* 캘린더<br>   - 내 캘린더(공유 받은 캘린더 미포함): 일정 내 첨부 파일, 본문 이미지<br>   - 구독 캘린더<br>\* 개인 프로젝트(업무) : 업무 내 첨부 파일, 본문/댓글 이미지<br>\* 메신저(나와의 대화방) : 첨부 파일 (이미지 포함) | \* 일반 프로젝트(업무): 업무 내 첨부 파일, 본문/댓글 이미지<br>\* 일반 프로젝트(드라이브): 업로드 된 파일 (휴지통 용량 포함)<br>\* 일반 프로젝트(위키): 페이지 내 첨부 파일, 본문/댓글 이미지<br>\* 일반 프로젝트(캘린더): 용량 산정 항목 아님<br>\* 메일: 대용량 첨부 메일 쓰기 시 대용량 첨부 파일<br>\* 메신저(일반 대화방): 첨부 파일 (이미지 포함) | \* 메일 : 메일 쓰기 시 첨부한 대용량 파일 |
