...
| 메일 | \* 캘린더 <br>   - 내 캘린더(공유 받은 캘린더 미포함): 일정 내 첨부 파일, 본문 이미지<br>   - 구독 캘린더<br>\* 드라이브: 업로드 된 파일 (휴지통 용량 포함)<br>\* 메일: 메일함 내 모든 메일 (휴지통 용량 포함)<br>\* 메신저(나와의 대화방) : 첨부 파일 (이미지 포함) | \* 메신저(일반 대화방): 첨부 파일 (이미지 포함) | \* 메일 : 메일 쓰기 시 첨부한 대용량 파일 |
