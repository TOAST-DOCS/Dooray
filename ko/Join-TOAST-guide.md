...
2) 관리자
어드민에서 생성된 일반 프로젝트를 확인 후 불필요한 프로젝트나 데이터를 정리해 주세요. (가입 상품에 따라 다름) 

* 생성되었으나 활용하지 않는 일반 프로젝트 확인/정리
   * 어드민> 조직 서비스 관리 > 프로젝트 설정 > 전체 프로젝트

* 기 '삭제'상태인 일반 프로젝트 재확인/영구 삭제 정리 
...
##### 메일
1) 개별 구성원(개인 용량 관리)
개인 용량 초과 시 각 구성원(멤버, 손님)은 메일함을 백업/삭제해 개인 용량을 확보할 수 있습니다.
* 메일 내보내기 후 삭제
...
2) 관리자 (메일 공용 용량(대용량 첨부) 관리) 
메일 공용 용량이 초과한 경우 대용량 첨부 설정을 변경하거나 (Business상품의 경우)불필요한 대용량 파일을 삭제할 수 있습니다.
* 대용량 첨부 파일 용량/다운로드 기간 설정 변경 가능
   * 어드민> 조직 서비스 관리 > 메일 설정 > 파일 첨부
* (Business 가입의 경우)  대용량 첨부 파일 삭제 가능
