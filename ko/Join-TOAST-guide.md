...
2) 기 '삭제'상태인 일반 프로젝트 재확인/영구 삭제 정리 (어드민> 조직 서비스 관리 > 프로젝트 설정 > 전체 프로젝트 > 삭제(보관) 상태 필터 후 확인)
...
1) 대용량 첨부 파일 용량/다운로드 기간 설정 변경 가능 (어드민> 조직 서비스 관리 > 메일 설정 > 파일 첨부)

2) (Business 가입의 경우)  대용량 첨부 파일 삭제 가능 (어드민> 조직 관리 > 메일 공용 용량 > 대용량 첨부 발송)
