...
무료 상품을 이용하실 경우에도 기한 내에 **반드시NHN Cloud 상품 가입 신청**하셔야 계속 이용할 수 있습니다.
...
필요한 경우 데이터 백업 후 NHN Cloud 상품 가입을 진행해 주세요.(아래 상품별 이용 가능 서비스 참고 [자세히](https://dooray.com/home/pricing/#messenger))
